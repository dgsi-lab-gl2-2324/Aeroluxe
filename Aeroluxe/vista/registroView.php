            ...
            <div class="form-container">
                ...
                <form method="post" action="<?php echo URL . '/registrarse'; ?>" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="dni" pattern="^[0-9]{8}[TRWAGMYFPDXBNJZSQVHLCKE]$" maxlength="9" placeholder="01234567A" required class="form-control" title="Por favor, introduzca un DNI válido. Ejemplo: 12345678Z">
                    </div>
                    <div class="col-md-12">
