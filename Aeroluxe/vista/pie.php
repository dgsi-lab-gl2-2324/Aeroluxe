        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    ...
                    <p>Al suscribirte obtendrás noticias actualizadas sobre nuestros servicios además de un 10% de descuento para la primera compra.</p>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-2 col-md-12 footer-contact text-center text-md-start">
                    ...
                    <p>
                        ...
                        Zaragoza, Aragón <br>
                        <b>España <br><br></b>
                        <strong>Teléfono:</strong> 925 72 10 10<br>
...
<!-- Vendor JS Files -->
<script src="<?php echo URL ?>/assets/vendor/purecounter/purecounter_vanilla.js"></script>
