    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Aeroluxe, donde la tecnología y el lujo</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">te elevan al confort y exclusividad</h2>
  ...
  <section id="inicio-sesion-section" class="inicio-sesion-section">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="<?php echo URL ?>/assets/img/about.jpg" class="img-fluid" alt="">
          </div>
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h2>Nuestras estancias</h2>
          <p>Lugares para descubrir nuevas experiencias</p>
        </header>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="box">
              ...
              <h3>Piscina flotante</h3>
              <p>Relájese en las aguas purificadas de la piscina más exclusiva.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <h3>Restauración</h3>
              <p>Disfrute de nuestros manjares exquisitos.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
            <div class="box">
              ...
              <h3>Aseo inteligente</h3>
              <p>Viva una experiencia única y privada con nuestos aseos inteligentes.</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="member-img">
                <img src="<?php echo URL ?>/assets/img/team/team-3.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="<?php echo URL ?>/assets/img/clients/client-1.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php echo URL ?>/assets/img/clients/client-2.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php echo URL ?>/assets/img/clients/client-3.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php echo URL ?>/assets/img/clients/client-4.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php echo URL ?>/assets/img/clients/client-5.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php echo URL ?>/assets/img/clients/client-6.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php echo URL ?>/assets/img/clients/client-7.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php echo URL ?>/assets/img/clients/client-8.png" class="img-fluid" alt=""></div>
          </div>
          <div class="swiper-pagination"></div>
        </div>
      </div>
    ...
    <section id="contact" class="contact">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6">
            <form action="<?php echo URL ?>/forms/contact.php" method="post" class="php-email-form">
              <div class="row gy-4">
